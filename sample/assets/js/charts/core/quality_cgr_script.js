...
var url_target      = base_url+'core_quality_cgr/';

var chart2          = new Array();
var destination     = ["qm_cgr_scr"];
var target_function = ["js_getdata_scr"];
var func_controller = ["js_cont_qual_cgr_1"];
var chart_title     = ["CGR SCR"];
...
$(document).ready(function() {
    for (var i = 0; i < func_controller.length; i++) {
        display_quality_cgr(chart2[i], destination[i], func_controller[i], chart_title[i]);
    }
...
function display_quality_cgr(highchart, chart_id, func_controller, chart_title){
