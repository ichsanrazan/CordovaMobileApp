...
var url_target      = base_url+'core_capacity_cgr/';

var chart2          = new Array();
var destination     = ["qm_cgr_occupancy"];
var target_function = ["js_getdata_occupancy"];
var func_controller = ["js_cont_cap_cgr_1"];
var chart_title     = ["CGR OCCUPANCY"];
...
$(document).ready(function() {
    for (var i = 0; i < func_controller.length; i++) {
        display_capacity_cgr(chart2[i], destination[i], func_controller[i], chart_title[i]);
    }
...
function display_capacity_cgr(highchart, chart_id, func_controller, chart_title){
